...
class PostRepository
{
    ...
    public function createMissingPost($values, $post)
    {
        ...
        $params = ['missing_type', 'language', 'badge_awarded', 'duo_location', 'is_draft', 'has_tattoo', 'fullname', 'aka', 'dob', 
            ...
            'circumstance', 'contact_email', 'contact_phone_number1', 'contact_phone_number2', 'verification_groupchat_link', 'company_name', 'missing-location-latitude', 'missing-location-longitude',
        ];
